      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="shadow-lg border-l-4 border-l-indigo-500">
              <CardContent className="p-6">
                <h3 className="text-2xl font-bold mb-6 text-indigo-700 flex items-center">
                  🚌 Transportation & Meeting Point - Getting There Made Easy
                </h3>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold text-lg mb-3 text-gray-800">Meeting Point</h4>
                    <div className="bg-indigo-50 p-4 rounded-lg">
                      <p className="text-indigo-800 font-medium mb-2">
                        📍 {post.meetingPoint || "Central Station Main Entrance"}
                      </p>
                      <p className="text-sm text-indigo-600">
                        Look for our guide with the company sign. Please arrive 15 minutes early.
                      </p>
                    </div>
                  </div>
                  <div>
                    <h4 className="font-semibold text-lg mb-3 text-gray-800">Transportation Options</h4>
                    <div className="space-y-2">
                      <div className="flex items-center">
                        <span className="text-indigo-500 mr-3">🚇</span>
                        <span className="text-gray-700">Accessible by metro/subway</span>
                      </div>
                      <div className="flex items-center">
                        <span className="text-indigo-500 mr-3">🚌</span>
                        <span className="text-gray-700">Public bus routes available</span>
                      </div>
                      <div className="flex items-center">
                        <span className="text-indigo-500 mr-3">🚗</span>
                        <span className="text-gray-700">Parking available nearby</span>
                      </div>
                      <div className="flex items-center">
                        <span className="text-indigo-500 mr-3">🚕</span>
                        <span className="text-gray-700">Taxi/rideshare pickup zone</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <Card className="shadow-lg border-l-4 border-l-teal-500">
              <CardContent className="p-6">
                <h3 className="text-2xl font-bold mb-6 text-teal-700 flex items-center">
                  ♿ Accessibility Information - Inclusive Travel Experience
                </h3>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold text-lg mb-3 text-gray-800">Accessibility Features</h4>
                    <div className="space-y-2">
                      <div className="flex items-center">
                        <span className="text-teal-500 mr-3">♿</span>
                        <span className="text-gray-700">Wheelchair accessible routes available</span>
                      </div>
                      <div className="flex items-center">
                        <span className="text-teal-500 mr-3">👂</span>
                        <span className="text-gray-700">Audio assistance for hearing impaired</span>
                      </div>
                      <div className="flex items-center">
                        <span className="text-teal-500 mr-3">🦮</span>
                        <span className="text-gray-700">Service animals welcome</span>
                      </div>
                    </div>
                  </div>
                  <div>
                    <h4 className="font-semibold text-lg mb-3 text-gray-800">Special Accommodations</h4>
                    <p className="text-gray-600 mb-3">
                      We strive to make our tours accessible to all guests. Please contact us in advance 
                      to discuss specific accessibility needs.
                    </p>
                ...
                <div className="space-y-3 text-sm">
                  {post.prefecture && (
                    <div className="flex items-center">
                      ...
                      <span>Location: {post.prefecture}</span>
                    </div>
                  )}
                  ...
                  {post.bestTime && (
                    <div className="flex items-center">
                      ...
                      <span>Best time: {post.bestTime}</span>
                    </div>
                  )}
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="text-lg font-bold mb-4">Share This Tour</h3>
            ...
            <Card className="bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200">
              <CardContent className="p-6">
                <h3 className="text-lg font-bold mb-4 text-blue-800">Need Help?</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-center">
                  ...
                  <div className="flex items-center">
                    <span className="text-blue-600 mr-2">📧</span>
                    <span>support@tourcompany.com</span>
                  </div>
                  <div className="flex items-center">
                    <span className="text-blue-600 mr-2">💬</span>
          ...
          <div className="lg:col-span-1 space-y-6">
            {/* Booking Card */}
            <Card className="sticky top-4 shadow-xl border-2 border-emerald-200">
              <CardContent className="p-6">
                <div className="text-center mb-6">
                  <div className="text-4xl font-bold text-emerald-700 mb-2">{safePrice}</div>
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center">
                      <span className="font-medium mr-1">{safeRating}</span>
                      <span className="text-sm text-gray-500">({safeRatingCount} reviews)</span>
                    </div>
                  </div>
                ...
                <div className="space-y-3 mb-6 p-4 bg-green-50 rounded-lg">
                  ...
                  {post.reserveNowPayLater?.available && (
                    <div className="flex items-center">
                      <span className="text-green-600 mr-2">✓</span>
                      <span className="text-sm text-gray-700">Reserve now, pay later option</span>
                    </div>
                  )}

                  {post.liveTourGuide?.available && (
                    <div className="flex items-center">
                      <span className="text-green-600 mr-2">✓</span>
                      <span className="text-sm text-gray-700">
                        Live tour guide in {post.liveTourGuide.languages?.join(", ") || "multiple languages"}
                      </span>
                    </div>
                  )}
                ...
                <div className="space-y-3">
                  <Button className="w-full bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white font-semibold py-3 text-lg shadow-lg">
                    🎫 Book Now
                  </Button>
                ...
                <div className="mt-4 text-center">
                  <p className="text-xs text-gray-500">Secure payment • No booking fees</p>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="fixed bottom-6 right-6 z-50">
          <Button
            onClick={handleBack}
            className="bg-emerald-600 hover:bg-emerald-700 text-white rounded-full p-4 shadow-2xl"
            size="lg"
          >
