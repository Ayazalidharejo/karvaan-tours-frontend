...
//       toast({
//         title: "Error", 
//         description: "Failed to load short forms",
//         variant: "destructive"
//       });
//     }
//   };

//   // Load detail forms from backend
...
//       toast({
//         title: "Error",
//         description: "Failed to load detail forms", 
//         variant: "destructive"
//       });
//     }
//   };
...
//         setShortForms([newItem, ...shortForms]);
//       } else if (activeTab === 'detail-forms') {
//         setDetailForms([newItem, ...detailForms]);
//       }
...
//       toast({
//         title: "Error",
//         description: `Failed to create ${activeTab.replace('-', ' ')}`,
//         variant: "destructive"
//       });
//     } finally {
//       setIsLoading(false);
...
//         ));
//       } else if (activeTab === 'short-forms') {
//         setShortForms(shortForms.map(item => 
//           item._id === editingItem._id ? updatedItem : item
//         ));
//       } else if (activeTab === 'detail-forms') {
//         setDetailForms(detailForms.map(item => 
//           item._id === editingItem._id ? updatedItem : item
//         ));
//       }
...
//       toast({
//         title: "Error",
//         description: `Failed to update ${activeTab.replace('-', ' ')}`,
//         variant: "destructive"
//       });
//     } finally {
//       setIsLoading(false);
...
//     if (!confirm(`Are you sure you want to delete this ${activeTab.replace('-', ' ')}?`)) {
//       return;
//     }
...
//       // Update state
//       if (activeTab === 'blogs') {
//         setBlogPosts(blogPosts.filter(item => item._id !== id));
//       } else if (activeTab === 'short-forms') {
//         setShortForms(shortForms.filter(item => item._id !== id));
//       } else if (activeTab === 'detail-forms') {
//         setDetailForms(detailForms.filter(item => item._id !== id));
//       }
...
//       toast({
//         title: "Error", 
//         description: `Failed to delete ${activeTab.replace('-', ' ')}`,
//         variant: "destructive"
//       });
//     }
//   };
...
//       }
//     } else if (activeTab === 'detail-forms') {
//       if (!formData.name || !formData.nameJp || !formData.category || !formData.description) {
//         toast({
//           title: "Error",
//           description: "Please fill in all required fields",
//           variant: "destructive"
...
//         );
//       case 'short-forms':
//         return shortForms.filter(item =>
//           item.title.toLowerCase().includes(searchTerm.toLowerCase())
//         );
//       case 'detail-forms':
//         return detailForms.filter(item =>
...
//                             onChange={(e) => setFormData({...formData, includes: e.target.value.split(',').map(item => item.trim())})}
...
//                               onChange={(e) => setFormData({...formData, [key]: e.target.value.split(',').map(item => item.trim())})}
...
//                   <p className="text-muted-foreground">
//                     {searchTerm ? "Try adjusting your search terms" : `Create your first ${activeTab.replace('-', ' ')} to get started`}
//                   </p>
//                 </div>
//               ) : (
...
//                             {activeTab === 'short-forms' && `${item.price} • ${item.duration} • Rating: ${item.rating}`}
//                             {activeTab === 'detail-forms' && `${item.category} • ${item.prefecture} • ${item.description?.substring(0, 100)}`}
//                             ...
//                           </p>
...
//               {/* Detail Form Edit - Same as create but with edit- prefixes */}
//               {activeTab === 'detail-forms' && (
//                 <>
//                   <div className="grid grid-cols-2 gap-4">
//                     <div>
